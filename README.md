# osi_model_for_ctf_networking

# Networking(osi model)

The OSI (**O**pen **S**ystems **I**nterconnection) Model is a standardised model which we use to demonstrate the theory behind computer networking. In practice, it's actually the more compact TCP/IP model that real-world networking is based off; however the OSI model, in many ways, is easier to get an initial understanding from.

This have seven layer….

![OSI-Table.png](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/070d8410-9373-41dc-ab68-cabe48fab62c/OSI-Table.png)

For memorize this name we can use a short form which is APSTNDP..

Layer 7 -- Application:

This application layer of the osi model essentially provides networking options to programs running on a  computer. It works almost exclusively with applications,providing an interface for them to use in order to transmit [data.](http://data.It) It is use by network applications like google,firefox,outlook. It uses application layer potocol like http,https.
